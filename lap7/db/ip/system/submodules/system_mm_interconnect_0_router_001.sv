...
(
    ...
    localparam PAD2 = log2ceil(64'h110a0 - 64'h11090); 
    localparam PAD3 = log2ceil(64'h110b0 - 64'h110a0); 
    ...
    localparam PAD9 = log2ceil(64'h11110 - 64'h11108); 
    // -------------------------------------------------------
    ...
    // ( 0x11090 .. 0x110a0 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 17'h11090   ) begin
    ...
    // ( 0x110b0 .. 0x110c0 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 17'h110b0   ) begin
    ...
    // ( 0x110f0 .. 0x11100 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h110f0  && read_transaction  ) begin
            src_channel = 11'b0000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x11108 .. 0x11110 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 17'h11108   ) begin
